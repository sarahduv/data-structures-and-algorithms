...
const createList = (availableItems) => {
  ...
  availableItems.forEach((object) => {
    if (object.available === true) {
      listOfAvailableItems.push(object.name);
    }
  });
...
Run your tests from the console: jest challenges-01.test.js / npm test challenges-01.test.js
